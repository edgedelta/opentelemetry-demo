module github.com/edgedelta/opentelemetry-demo/src/checkoutservice
...
require (
	...
	buf.build/gen/go/open-feature/flagd/protocolbuffers/go v1.34.2-20240906125204-0a6a901b42e8.2 // indirect
	...
	github.com/open-feature/flagd/core v0.10.3 // indirect
